  ...
  return (
    <main style={{
      ...
      <div style={{ maxWidth: CONTENT_MAX_WIDTH, margin: '0 auto', padding }}>
        ...
        {/* STEP 1: 단어장 선택 */}
        {step === 'folder' && (
          <div key={step} style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '16px', animation: 'pageFadeIn 0.25s ease both' }}>
            {folders.map(folder => (
              <div
                key={folder.id}
        ...
        {step === 'format' && (
          <div key={step} style={{ animation: 'pageFadeIn 0.25s ease both' }}>
        ...
        {/* STEP 4: 완료 */}
        {step === 'done' && (
          <div key={step} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: '20px', animation: 'pageFadeIn 0.25s ease both' }}>
